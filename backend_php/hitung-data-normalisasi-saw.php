...
//ANGGOTA KELUARGA
    ...
    {   
        ...
        $arr_data_normalisai_saw[] = ["nama_id_alternatif" => $var_nama_id_alternatif, "pendidikan" => (string)$hasil_pendidikan ,
         "pekerjaan" => (string)$hasil_pekerjaan , "penghasilan" => (string)$hasil_penghasilan , 
         "anggota_keluarga" => (string)$hasil_anggota_keluarga ];
    ...
    usort($arr_data_normalisai_saw, make_comparer(['nama_id_alternatif', SORT_DESC]));

	echo json_encode(["success"=>1,"data_normalisasi_saw"=>$arr_data_normalisai_saw]);
