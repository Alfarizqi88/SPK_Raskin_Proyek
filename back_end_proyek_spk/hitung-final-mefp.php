...
//PENDIDIKAN
        ...
        $count++;
        $arr_data_range_final_mefp[] = ["nama_id_alternatif" => $var_nama_id_alternatif,  'total' => (string)$total];
    }
    ...
    usort($arr_data_range_final_mefp, make_comparer(['total', SORT_ASC]));
    
    
    

    echo json_encode(["success"=>1,"data_final_mefp"=>$arr_data_range_final_mefp]);
}
